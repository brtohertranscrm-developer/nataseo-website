const en = {
  ...
  portfolio: {
    ...
    h2a: 'Built to',
    h2b: 'Deliver',
    desc: 'We may be new, but we know exactly what it takes to grow a business online. Here\'s what we offer for you.',
    cta: 'Discuss Your Project',
    ctaDesc: 'Have a specific project in mind? Let\'s talk about what we can build for you.',
    categories: ['All', 'Web Engine', 'SEO', 'Content', 'Software'],
    items: [
      {
        title: 'SEO for Online Store',
        description: 'We research the best keywords, fix technical issues, and build your website authority so your products appear when people search.',
        goal: 'Goal: Page 1 Ranking',
        industry: 'E-Commerce',
      },
      {
        title: 'High-Converting Website',
        description: 'We design fast, attractive mobile-first websites that guide visitors to take action — inquiry, purchase, or call.',
        goal: 'Goal: More Conversions',
      ...
      },
      {
        ...
        goal: 'Goal: Save Time & Cost',
        industry: 'Business & Enterprise',
      },
      {
        title: 'SEO Content Strategy',
        description: 'We write articles, landing pages, and product copy that rank on Google and speak directly to your ideal customers.',
        goal: 'Goal: Organic Leads In',
        industry: 'All Sectors',
      },
      {
        title: 'Business Portal & Catalog',
        ...
        goal: 'Goal: Better User Experience',
        industry: 'Property & F&B',
      },
      {
        title: 'Local SEO',
        description: 'We help your business appear on Google Maps and "near me" searches so local customers find you before your competitors.',
        goal: 'Goal: Local Visibility',
