const id = {
  ...
  portfolio: {
    ...
    h2a: 'Dibangun untuk',
    h2b: 'Menghasilkan',
    desc: 'Kami mungkin baru, tapi kami tahu persis apa yang dibutuhkan untuk mengembangkan bisnis secara online. Inilah yang kami tawarkan untuk Anda.',
    cta: 'Diskusikan Project Anda',
    ctaDesc: 'Punya project tertentu dalam pikiran? Mari bicara tentang apa yang bisa kami bangun untuk Anda.',
    categories: ['Semua', 'Web Engine', 'SEO', 'Content', 'Software'],
    items: [
      {
        title: 'SEO untuk Toko Online',
        description: 'Kami meneliti keyword terbaik, memperbaiki masalah teknis, dan membangun otoritas website Anda agar produk Anda muncul saat orang mencari.',
        goal: 'Target: Ranking Halaman 1',
        industry: 'E-Commerce',
      },
      {
        title: 'Website Berkonversi Tinggi',
        description: 'Kami mendesain website mobile-first yang cepat dan menarik yang memandu pengunjung untuk mengambil tindakan — inquiry, pembelian, atau panggilan.',
        goal: 'Target: Lebih Banyak Konversi',
        industry: 'Semua Industri',
      },
      {
        title: 'Sistem Bisnis Custom',
        description: 'Kami membangun web app dan tools internal yang disesuaikan dengan alur kerja Anda — dari dashboard sederhana hingga sistem manajemen yang kompleks.',
        goal: 'Target: Hemat Waktu & Biaya',
        industry: 'Bisnis & Enterprise',
      },
      {
        title: 'Strategi Konten SEO',
        description: 'Kami menulis artikel, landing page, dan copy produk yang tampil di Google dan berbicara langsung kepada pelanggan ideal Anda.',
        goal: 'Target: Leads Organik Masuk',
        industry: 'Semua Sektor',
      },
      {
        title: 'Portal & Katalog Bisnis',
        description: 'Butuh portal listing, sistem booking, atau katalog produk? Kami membangun platform kaya fitur yang dibangun di sekitar model bisnis Anda.',
        goal: 'Target: Pengalaman Pengguna Lebih Baik',
        industry: 'Properti & F&B',
      },
      {
        title: 'SEO Lokal',
        description: 'Kami membantu bisnis Anda muncul di Google Maps dan pencarian "terdekat" agar pelanggan lokal menemukan Anda sebelum menemukan kompetitor.',
        goal: 'Target: Visibilitas Lokal',
