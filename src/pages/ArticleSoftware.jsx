...
const URL = 'https://nataseo.asia/artikel/jasa-software-development-yogyakarta'
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta property="og:image" content="https://nataseo.asia/og/jasa-software-development.svg" />
        <meta property="og:locale" content="id_ID" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={TITLE} />
        <meta name="twitter:description" content={DESC} />
        <meta name="twitter:image" content="https://nataseo.asia/og/jasa-software-development.svg" />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "BlogPosting",
          "headline": "Jasa Software Development Yogyakarta: Solusi Sistem Custom untuk Bisnis Anda",
          "description": DESC,
          "url": URL,
          ...
          "image": "https://nataseo.asia/og/jasa-software-development.svg",
          "inLanguage": "id",
          "breadcrumb": {
            "@type": "BreadcrumbList",
            "itemListElement": [
              { "@type": "ListItem", "position": 1, "name": "Beranda", "item": "https://nataseo.asia" },
              { "@type": "ListItem", "position": 2, "name": "Jasa Software Development Yogyakarta" }
            ]
          }
        })}</script>
      </Helmet>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
        <Breadcrumb items={[{ label: t.breadcrumb.home, href: '/' }, { label: 'Software Development' }]} />
