  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta property="og:image" content="https://nataseo.asia/og/strategi-content-marketing.svg" />
        <meta property="og:locale" content="id_ID" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={TITLE} />
        <meta name="twitter:description" content={DESC} />
        <meta name="twitter:image" content="https://nataseo.asia/og/strategi-content-marketing.svg" />
        <script type="application/ld+json">{JSON.stringify({
          ...
          "image": "https://nataseo.asia/og/strategi-content-marketing.svg",
          "inLanguage": "id",
          "breadcrumb": {
            "@type": "BreadcrumbList",
            "itemListElement": [
