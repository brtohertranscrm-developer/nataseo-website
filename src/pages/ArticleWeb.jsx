  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta property="og:image" content="https://nataseo.asia/og/jasa-pembuatan-website-yogyakarta.svg" />
        <meta property="og:locale" content="id_ID" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={TITLE} />
        <meta name="twitter:description" content={DESC} />
        <meta name="twitter:image" content="https://nataseo.asia/og/jasa-pembuatan-website-yogyakarta.svg" />
        <script type="application/ld+json">{JSON.stringify({
          ...
          "image": "https://nataseo.asia/og/jasa-pembuatan-website-yogyakarta.svg",
          "inLanguage": "id",
          "breadcrumb": {
            "@type": "BreadcrumbList",
            "itemListElement": [
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
        <Breadcrumb items={[{ label: t.breadcrumb.home, href: '/' }, { label: 'Jasa Pembuatan Website' }]} />
