...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative w-14 h-14 bg-[#25D366] hover:bg-[#20bc5a] rounded-full shadow-lg shadow-green-500/40 flex items-center justify-center transition-all duration-200 hover:scale-110">
        {/* Pulse ring */}
