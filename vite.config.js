...
const ROUTES = [
  ...
  { path: '/jasa-seo-sleman',                                     priority: '0.9', changefreq: 'weekly'  },
  { path: '/jasa-seo-bantul',                                     priority: '0.9', changefreq: 'weekly'  },
  { path: '/jasa-seo-travel-agent',                               priority: '0.9', changefreq: 'weekly'  },
  { path: '/jasa-seo-rental-kendaraan',                           priority: '0.9', changefreq: 'weekly'  },
  { path: '/jasa-seo-hotel',                                      priority: '0.9', changefreq: 'weekly'  },
